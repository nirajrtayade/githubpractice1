...
activities = {
    "Drama Club": {
        "description": "Perform in theatrical productions and explore acting techniques",
    ...
    "Science Club": {
        ...
        "max_participants": 18,
        "participants": ["david@mergington.edu", "rachel@mergington.edu", "chris@mergington.edu"]
    },
    "Basketball Team": {
